...
public class ReportMonthData {
	...
	private double MonAvlbltRat;
	private double MonAvlbltHour;
	private double MonNormTim;
	private double MonRunTim;
	private double MonStopTim;
	private double MonErrEmeTim;
	private double MonSerTim;
	private double MonGridErrTim;
	
	
	
	public ReportMonthData() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ReportMonthData(String nAME, int id, double max_windspeed, double avg_windspeed, double min_windspeed,
			...
			int rtghYawMotorCCWCou, int yawCWCou, double monthgenwh, int winTurStCovCont, int serModTimes,
			int winTurErrCovCont, int convMaiSwitchCou, int winHigErrTimes, int winTurCatInCont, int winTurArtStpCont,
			double monAvlbltRat, double monAvlbltHour, double monNormTim, double monRunTim, double monStopTim,
			double monErrEmeTim, double monSerTim, double monGridErrTim) {
		super();
		NAME = nAME;
		this.id = id;
		...
		MonAvlbltRat = monAvlbltRat;
		MonAvlbltHour = monAvlbltHour;
		MonNormTim = monNormTim;
		MonRunTim = monRunTim;
		MonStopTim = monStopTim;
		MonErrEmeTim = monErrEmeTim;
		MonSerTim = monSerTim;
