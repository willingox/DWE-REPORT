...
public class ReportYearData {
	...
	private double YeaAvlbltRat;
	
	
	public ReportYearData() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ReportYearData(String name, int id, double max_windspeed, double avg_windspeed, double min_windspeed,
			...
			int rtghYawMotorCCWCou, int yawCWCou, double yeargenwh, int winTurStCovCont, int serModTimes,
